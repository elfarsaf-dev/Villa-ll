...
<footer class="px-6 py-10" style="background:#ecefec;border-top:1px solid #bfc9c1">
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <a href="/admin/index.html" class="text-[10px] tracking-widest uppercase text-on-surface-variant hover:text-primary transition-colors flex items-center gap-1"><span class="material-symbols-outlined" style="font-size:14px">settings</span>Admin Dashboard</a>
  </div>
